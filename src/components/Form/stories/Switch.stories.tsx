  ...
  render: () => (
    <Form defaultValues={{ sm: false, md: false, lg: false }} onSubmit={() => {}}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <FormSwitch name="sm" label="Small switch" size="sm" />
        <FormSwitch name="md" label="Medium switch" size="md" />
        <FormSwitch name="lg" label="Large switch" size="lg" />
      </div>
    </Form>
  ),
};
  ...
  render: () => (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '350px' }}>
        ...
        <FormSwitch name="notifications" label="Push notifications" />
        <FormSwitch name="emails" label="Email notifications" />
        <FormSwitch name="sms" label="SMS notifications" />
